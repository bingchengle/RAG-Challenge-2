...
class LLMReranker:
    ...
    def get_rank_for_single_block(self, query, retrieved_document):
        ...
        response_dict, _ = chat_structured_parse(
            self.llm, self._chat_model, messages, self.schema_for_single_block, temperature=0, seed=None
        )
    ...
    def get_rank_for_multiple_blocks(self, query, retrieved_documents):
        ...
        response_dict, _ = chat_structured_parse(
            self.llm, self._chat_model, messages, self.schema_for_multiple_blocks, temperature=0, seed=None
        )
        return response_dict
